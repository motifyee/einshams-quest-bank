import{r as d,j as i}from"./react-2785220f.js";import{c as M}from"./react-dom-ee953f5b.js";import{c as h}from"./@reduxjs-4d3d6157.js";import{v as m}from"./uuid-a960c1f4.js";import{T as D,a as k}from"./@azure-6e10cfef.js";import{d as B}from"./device-detector-js-8f92b5ad.js";import"./firebase-86d04f59.js";import{i as F,P as R,_ as P,p as _,G as L}from"./@firebase-3a88a537.js";import"./scheduler-04ce0582.js";import"./tslib-87ab7759.js";import"./idb-81bdbf9b.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function e(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=e(o);fetch(o.href,r)}})();const U=h("questions/add",t=>({payload:{question:t}})),H=h("questions/remove",t=>({payload:{questionId:t}})),Z=h("questions/update",(t,s)=>({payload:{questionId:t,...s}})),y=h("questions/set",(t,s)=>({payload:{questions:t,shuffle:s}})),q=h("questions/shuffle",(t,s)=>({payload:{questions:t,shuffle:s}})),S=h("questions/answers/selectOne",(t,s)=>({payload:{questionId:t,answerId:s}})),G=h("questions/answers/unselectOne",t=>({payload:{questionId:t}})),O=h("questions/answers/unselectAll"),K=h("questions/answers/shuffleOne",(t,s,e)=>({payload:{questionId:t,question:s,shuffle:e}}));h("questions/answers/shuffleAll",(t,s)=>({payload:{questions:t,shuffle:s}}));const V=(t,s)=>{if(s.type===U.type)return[...t,s.payload.question];if(s.type===H.type)return t.filter(e=>e.id!==s.payload.questionId);if(s.type===Z.type)return t.map(e=>e.id===s.payload.questionId?{...e,...s.payload}:e);if(s.type===y.type){const{shuffle:e,questions:n}=s.payload;return e?[...n].sort(()=>Math.random()-.5):[...n]}if(s.type===q.type){const{shuffle:e,questions:n}=s.payload;if(!e){const o=t.reduce((r,a)=>({...r,[a.id]:a.answers}),{});return n.map(r=>({...r,answers:o[r.id]}))}return[...t].sort(()=>Math.random()-.5)}if(s.type===S.type)return t.map(e=>e.id===s.payload.questionId?{...e,correct:e.answers.some(n=>n.correct&&n.id===s.payload.answerId),selectedId:s.payload.answerId,answers:e.answers.map((n,o)=>({...n,selected:n.id===s.payload.answerId}))}:e);if(s.type===G.type)return t.map(e=>{var n;return e.id===((n=s==null?void 0:s.payload)==null?void 0:n.questionId)?{...e,answers:e.answers.map((o,r)=>({...o,selected:!1}))}:e});if(s.type===O.type)return t.map(e=>({...e,selectedId:void 0,correct:void 0,answers:e.answers.map(n=>({...n,selected:!1}))}));if(s.type===K.type){let{questionId:e,question:n,shuffle:o}=s.payload;return o?t.map(r=>{if(r.id===e){const a=[...r.answers];for(let c=a.length-1;c>0;c--){const l=Math.floor(Math.random()*(c+1));[a[c],a[l]]=[a[l],a[c]]}return{...r,answers:a}}return r}):t.map(r=>r.id===e?n:r)}return[]},$={subject:"",questions:[],unbluredQuestion:"",sidebarOn:!1,testModeOn:!1,correctAnswers:!1,shuffleQuestions:!1,shuffleAnswers:!1,blurAnswers:!1};function g({id:t,questionText:s,answers:e,image:n,imageAlt:o}){return{id:t||m(),questionText:s,answers:e,get correctAnswers(){return this.answers.filter(r=>r.correct&&r.selected).length},image:n,imageAlt:o}}const W=`
...
`,z=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},X=W.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=z(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),J=`
...
`).filter(c=>c.trim().length>0),n=e.shift()||"failed to parse question",o=Number((a=e.shift())==null?void 0:a.trim());const r=e.map((c,l)=>({id:m(),text:c,correct:l+1===o}));return g({questionText:n,answers:r})}),ee=`
...
`).filter(c=>c.trim().length>0),n=e.shift()||"failed to parse question",o=Number((a=e.shift())==null?void 0:a.trim());const r=e.map((c,l)=>({id:m(),text:c,correct:l+1===o}));return g({questionText:n,answers:r})}),se=`
...
`,ne=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},re=se.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=ne(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),ie=`
...
`,oe=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},ae=ie.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=oe(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),ce=`
...
`,le=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},ue=ce.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=le(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),de=`
...
`,pe=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},fe=de.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=pe(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),me=`
...
`,he=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},ge=me.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=he(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),xe=`
...
`,be=t=>{let[,s,e]=/^!\[(.*)\]\((.*)\)$/.exec(t)||[];return[!!e,s,e]},we=xe.split("#").map((t,s)=>{var u;let e=t.trim().split(`
`).filter(p=>p.trim().length>0),n=e.shift()||"failed to parse question",o=Number((u=e.shift())==null?void 0:u.trim()),[r,a,c]=be(e[0]);r&&e.shift();const l=e.map((p,f)=>({id:m(),text:p,correct:f+1===o}));return g({questionText:n,answers:l,image:c,imageAlt:a})}),Q={"إرشاد زراعي":X,"إدارة جودة — 1":ge,"إدارة جودة — 2":we,"تجارة دولية — 1":re,"تجارة دولية — 2":ae,"سياسة رزاعية — 1":Y,"سياسة رزاعية — 2":te,"تقييم مشروعات — 1":ue,"تقييم مشروعات — 2":fe},ve=()=>{},C=d.createContext(Q),A=d.createContext([]),w=d.createContext(()=>{}),b=d.createContext($),v=d.createContext(ve),je=({children:t})=>{const[s,e]=d.useState($),[n,o]=d.useReducer(V,[]);return i.jsx(v.Provider,{value:e,children:i.jsx(w.Provider,{value:o,children:i.jsx(C.Provider,{value:Q,children:i.jsx(b.Provider,{value:s,children:i.jsx(A.Provider,{value:n,children:t})})})})})},ye=""+new URL("burger.svg",import.meta.url).href;async function Ce(){let t="https://icsltn2qastore.table.core.windows.net/?sv=2022-11-02&ss=t&srt=sco&sp=rwdlacu&se=2123-05-17T10:14:54Z&st=2023-05-17T02:14:54Z&spr=https&sig=D1FbXTuBcFKeEJ5lUw14FlIFRb4kl2C84uU9c90aqEA%3D",s="BlobEndpoint=https://icsltn2qastore.blob.core.windows.net/;QueueEndpoint=https://icsltn2qastore.queue.core.windows.net/;FileEndpoint=https://icsltn2qastore.file.core.windows.net/;TableEndpoint=https://icsltn2qastore.table.core.windows.net/;SharedAccessSignature=sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2023-06-18T00:28:14Z&st=2023-05-17T16:28:14Z&spr=https,http&sig=%2F0%2FcHEiRTcKSwpRtQnKsy0mTf3sL%2BXuDwEc90ZL%2BpEo%3D";await D.fromConnectionString(s,{}).createTable("test");const n=new k(t,"test"),o={partitionKey:"hometasks",rowKey:"1",description:"take out the trash",dueDate:new Date(2015,6,20)};let r=await n.createEntity(o);console.log(r)}function Ae(){const t=d.useContext(b),s=d.useContext(v);function e(){s({...t,sidebarOn:!t.sidebarOn})}return i.jsxs("div",{className:"burger-btn sticky top-0 min-h-[50px] px-4 flex items-center justify-between bg-green-700 ",children:[i.jsx("div",{children:i.jsx("img",{className:"cursor-pointer",onClick:e,src:ye,alt:"Menu"})}),i.jsx("div",{onClick:()=>{Ce()},className:"text-slate-200 border-double border-b-4 text-xl cursor-pointer",children:t.subject}),i.jsx("div",{})]})}function Ie(){const t=d.useContext(b),s=d.useContext(A),e=d.useContext(w),n=t.testModeOn&&t.correctAnswers,o=d.useMemo(()=>t.testModeOn?(console.log("calculating..."),s.reduce((r,a)=>r+(a.correct?1:0),0)):0,[s]);return i.jsxs("div",{className:`bottombar ${n?"":"none"}`,children:[i.jsxs("div",{className:"score",children:[i.jsx("span",{className:"score__label",children:"Score: "}),i.jsxs("span",{className:"score__value",children:[o,"/",s.length]})]}),i.jsx("div",{className:"actions",children:i.jsx("button",{className:"",onClick:()=>e(O()),children:"مسح الإجابات"})})]})}const x={};function Ne(t,s,e=!0,n=100){d.useDebugValue(x);const[o,r]=d.useState(!1),a=l=>{var u;return(x[t]={...x[t],captured:l??((u=x[t])==null?void 0:u.captured)??!1}).captured};return o||a()||(s&&!e&&s(),!x[t].skip&&(s&&e&&s(),r(()=>a(!0)),setTimeout(()=>r(!1),n))),!o&&a()&&a(!1),[o,()=>t in x?x[t].skip=!0:!1]}const Pe=(t=35)=>("vibrate"in navigator&&navigator.vibrate(t),!0);function qe({id:t,index:s,question:e,answers:n}){const o=d.useContext(v),r=d.useContext(b),a=l=>{o({...r,unbluredQuestion:l}),Pe()},[c]=Ne(t,()=>"",!0,300);return i.jsxs("div",{className:"quest-container",children:[i.jsxs("h2",{className:`quest-text ${c&&"bg-slate-600"||""}`,children:[i.jsx("span",{className:"quest-span",children:s}),e]}),i.jsxs("div",{className:"quest-answers",children:[r.unbluredQuestion!==t&&r.blurAnswers&&!r.testModeOn&&i.jsx("div",{className:"blur",onDoubleClick:()=>a(t)}),n]})]})}const Se=d.memo(qe),N=(t=35)=>("vibrate"in navigator&&navigator.vibrate(t),!0);function Oe({question:t}){const s=d.useContext(b),e=d.useContext(w),n=f=>{if(!s.testModeOn)return console.log("testMode is off");if(s.correctAnswers&&t.selectedId)return N(60);e(S(t.id,f)),N()},o="bg-amber-700",r="bg-green-700",a="bg-red-700",c="bg-slate-800";function l(f){return s.testModeOn?s.correctAnswers?t.selectedId?f.selected?f.correct?r:a:f.correct?r:c:c:f.selected?o:c:f.correct?r:c}function u(f){return"answers"in f}const p=u(t)?t.answers:[t.answer];return i.jsx(i.Fragment,{children:p.map((f,I)=>f?i.jsxs("div",{className:`quest-answer ${l(f)}`,children:[i.jsx("input",{type:"radio",onClick:Ke=>n(f.id),name:"answer",id:`answer${t.id}${I}`,className:"hidden"}),i.jsx("label",{htmlFor:`answer${t.id}${I}`,className:"quest-answerlable p-2",children:f.text})]},f.id):"")})}function $e({question:t,index:s}){const e=Oe({question:t}),n=i.jsxs(i.Fragment,{children:[i.jsx("span",{children:t.questionText}),t.image&&i.jsx("img",{src:"./assets/"+t.image,alt:t.imageAlt,className:"quest-image w-full h-auto my-2 "})]}),o={id:t.id,index:s,question:n,answers:e};return i.jsx(Se,{...o})}function Qe({questPanel:t}){const s=d.useContext(A),e=d.useContext(b),n=d.useContext(v),o=d.useContext(C),r=d.useContext(w);return d.useEffect(()=>{if(!s.length){let a="إرشاد زراعي";n({...e,sidebarOn:!1,subject:a,questions:o[a]}),r(y(o[a],e.shuffleQuestions))}},[]),i.jsxs("div",{ref:t,className:"questions p-4 flex-1 overflow-y-auto",children:[s==null?void 0:s.map((a,c)=>i.jsxs("div",{children:[i.jsx($e,{question:a,index:c+1}),i.jsx("br",{})]},a.id)),i.jsx(Te,{questPanel:t})]})}function Te({questPanel:t}){const[s,e]=d.useState("");return i.jsx("div",{className:`scroll-top ${s}`,onClick:()=>{var n;return(n=t.current)==null?void 0:n.scrollTo({top:0,behavior:"smooth"})},onPointerMoveCapture:()=>e("hover"),onPointerDownCapture:()=>e("hover"),onPointerOutCapture:()=>e(""),onPointerUp:()=>e("")})}function Ee({defaultValue:t=!1,enabled:s=!0,onChange:e,setToggle:n,...o}){const r=d.useId(),a=d.useRef(null),c=u=>{var p;return e?e(((p=u.target)==null?void 0:p.checked)||!1):null};return n&&n(()=>{var u;return(u=a.current)==null?void 0:u.click()}),i.jsxs("label",{style:{},htmlFor:r,className:`toggle-switch ${s?"":"disabled"}`,children:[i.jsx("input",{id:r,ref:a,type:"checkbox",onChange:c,disabled:!s,onClick:u=>u.stopPropagation(),defaultChecked:t,...o}),i.jsx("span",{className:"slider"})]})}function Me({questPanel:t}){const s=d.useContext(b),e=d.useContext(v),n=d.useContext(C),o=d.useContext(w),{sidebarOn:r}=s,a=(c,l)=>{var u;switch(c){case"selectedSubject":return(u=t.current)==null||u.scrollTo({top:0,behavior:"smooth"}),e({...s,sidebarOn:!1,subject:l,questions:n[l]}),o(y(n[l],s.shuffleQuestions));case"testModeOn":return e({...s,testModeOn:l});case"correctAnswers":return e({...s,correctAnswers:l});case"blurAnswers":return e({...s,blurAnswers:l});case"shuffleQuestions":return e({...s,shuffleQuestions:l}),o(q([...n[s.subject]],l));case"shuffleAnswers":return e({...s,shuffleAnswers:l});default:return}};return i.jsxs("div",{className:"absolutez",children:[i.jsxs("nav",{onClick:c=>c.stopPropagation(),className:`${r?"":"off"} sidebar`,children:[i.jsxs("div",{className:"subjects",children:[i.jsx("h2",{className:"title",children:"البنك"}),i.jsx("div",{className:"sep"}),Object.keys(n).map(c=>i.jsx("div",{className:`item ${s.subject===c?"active":""}`,onClick:()=>a("selectedSubject",c),children:c},c))]}),i.jsxs("div",{className:"settings",children:[i.jsx("div",{className:"sep"}),i.jsx("div",{className:"title",children:"الاعدادات"}),i.jsx("div",{className:"sep"}),i.jsx(j,{title:"وضع الإختبار",defaultValue:s.testModeOn,action:c=>a("testModeOn",c)}),i.jsx(j,{title:"تصحيح الإجابات",enabled:s.testModeOn,defaultValue:s.correctAnswers,action:c=>a("correctAnswers",c)}),i.jsx("p",{}),i.jsx(j,{title:"تغشية الإجابات",enabled:!s.testModeOn,defaultValue:s.blurAnswers,action:c=>a("blurAnswers",c)}),i.jsx(j,{title:"مزج الأسئلة",defaultValue:s.shuffleQuestions,action:c=>a("shuffleQuestions",c)})]}),i.jsxs("div",{className:"credits",children:[i.jsx("div",{className:"sep"}),i.jsx("div",{className:"title",children:"الحقوق"}),i.jsx("div",{className:"sep"}),i.jsx("div",{className:"item",children:"motifyee@gmail.com"}),i.jsx("div",{className:"item",children:"م/ مليك روماني"})]})]}),i.jsx("div",{onPointerMove:c=>c.stopPropagation(),onPointerDownCapture:c=>c.stopPropagation(),onPointerDown:c=>c.stopPropagation(),onClick:()=>e({...s,sidebarOn:!1}),className:`${r?"":"off"} sidebar-overlay`})]})}function j({title:t,defaultValue:s,action:e,enabled:n=!0}){let o=()=>{};const r=a=>o=a;return i.jsxs("div",{onClick:a=>{a.preventDefault(),o()},className:"flex justify-between items-center item",children:[i.jsx("div",{className:`${n?"":"text-gray-500 xline-through"}`,children:t}),i.jsx(Ee,{defaultValue:s,enabled:n,onChange:e,setToggle:r})]})}const De=F({apiKey:"AIzaSyBWmWIAPvA97sn2RpVx0mfTBmCcgX-98o4",authDomain:"fir-computers-ip.firebaseapp.com",databaseURL:"https://fir-computers-ip.firebaseio.com",projectId:"fir-computers-ip",storageBucket:"fir-computers-ip.appspot.com",messagingSenderId:"369476238484",appId:"1:369476238484:web:f214ed67d25cdb30178881",measurementId:"G-05Z9EBZ84Z"}),T=R(De),E="ein-shams.web.app";P(T,E);const ke=async t=>(console.log("addFirebaseAction:"),console.table(t),await _(P(T,E),{date:L(),...t}));let Be=Fe();function Fe(){return localStorage.getItem("user")||""}async function Re(){return await fetch("https://api.ipify.org").then(t=>t.text())}async function _e(t,s){if(Be=="admin")return;console.log("saveAction",t,s);let e=await ke({action:t||"DEFAULT",value:s||"",deviceInfo:await Ue()});return console.log("saveAction",e),e}function Le(){return{width:window.screen.width,height:window.screen.height,availWidth:window.screen.availWidth,availHeight:window.screen.availHeight,colorDepth:window.screen.colorDepth,pixelDepth:window.screen.pixelDepth,orientation:{angle:window.screen.orientation.angle,type:window.screen.orientation.type}}}async function Ue(){let t=new B().parse(navigator.userAgent),s=Le(),e=await Re(),n=He();return{ip:e,screen:s,detector:t,deviceId:n}}function He(){let t=localStorage.getItem("machineId");return t||(t=m(),localStorage.setItem("machineId",t)),t}function Ze(){const t=d.useRef(null);return d.useEffect(()=>{window.location.href.includes("http://localhost")||_e()},[]),i.jsxs(je,{children:[i.jsx(Ae,{}),i.jsx(Me,{questPanel:t}),i.jsx(Qe,{questPanel:t}),i.jsx(Ie,{})]})}const Ge=document.getElementById("root");M.createRoot(Ge).render(i.jsx(Ze,{}));
