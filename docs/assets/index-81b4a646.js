import{r as c,j as o}from"./react-2a1b29a3.js";import{c as ae}from"./react-dom-0944c732.js";import{d as le}from"./device-detector-js-22233639.js";import"./firebase-86d04f59.js";import{i as ue,P as de,_ as z,p as fe,G as pe}from"./@firebase-3a88a537.js";import{v as p}from"./uuid-a960c1f4.js";import{B as he}from"./react-router-dom-8eb5b12f.js";import{c as m}from"./@reduxjs-4d3d6157.js";import{a as me,b as R}from"./react-router-58cad68c.js";import"./scheduler-04ce0582.js";import"./idb-81bdbf9b.js";import"./@remix-run-f34948fb.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const ge=ue({apiKey:"AIzaSyBWmWIAPvA97sn2RpVx0mfTBmCcgX-98o4",authDomain:"fir-computers-ip.firebaseapp.com",databaseURL:"https://fir-computers-ip.firebaseio.com",projectId:"fir-computers-ip",storageBucket:"fir-computers-ip.appspot.com",messagingSenderId:"369476238484",appId:"1:369476238484:web:f214ed67d25cdb30178881",measurementId:"G-05Z9EBZ84Z"}),Z=de(ge),J="agri-asu.web.app";z(Z,J);const B=async e=>(console.log("addFirebaseAction:"),console.table(e),await fe(z(Z,J),{date:pe(),...e}));let we=Ae();localStorage.getItem("install-date")||localStorage.getItem("install-date*")||localStorage.setItem("install-date*",new Date().toISOString());function Ae(){return localStorage.getItem("user")||""}async function xe(){return await fetch("https://api.ipify.org").then(e=>e.text())}function Ce(e){localStorage.removeItem(e)}function be(e){return Object.keys(localStorage).filter(t=>t.startsWith(`${e}-`)).map(t=>({key:t,idx:Number(t.replace(`${e}-`,"")),value:localStorage.getItem(t)||""}))}function ve(e,t){const s=be(e);let n=s.reduce((r,{idx:i})=>Math.max(r,i),0)+1;return localStorage.setItem(`${e}-${n}`,t||""),s.push({key:`${e}-${n}`,idx:n,value:t||""}),s}async function ye(e,t){if(we=="admin")return;e=e||"DEFAULT",t=t||new Date().toISOString();let s=ve(e,t);for(let r of s)try{await B({action:r.key,value:r.value,deviceInfo:await L()}),Ce(r.key)}catch{}let n=localStorage.getItem("install-date*");if(n)try{await B({action:"install-date",value:n,deviceInfo:await L()}),localStorage.setItem("install-date",n),localStorage.removeItem("install-date*")}catch{}}function je(){return{width:window.screen.width,height:window.screen.height,availWidth:window.screen.availWidth,availHeight:window.screen.availHeight,colorDepth:window.screen.colorDepth,pixelDepth:window.screen.pixelDepth,orientation:{angle:window.screen.orientation.angle,type:window.screen.orientation.type}}}async function L(){let e=new le().parse(navigator.userAgent),t=je(),s=await xe(),n=Ie();return{ip:s,screen:t,detector:e,deviceId:n}}function Ie(){let e=localStorage.getItem("machineId");return e||(e=p(),localStorage.setItem("machineId",e)),e}const Oe=m("questions/add",e=>({payload:{question:e}})),Se=m("questions/remove",e=>({payload:{questionId:e}})),Ne=m("questions/update",(e,t)=>({payload:{questionId:e,...t}})),$=m("questions/set",(e,t)=>({payload:{test:e,shuffle:t}})),Y=m("questions/shuffle",e=>({payload:{shuffle:e}})),ee=m("questions/answers/selectOne",(e,t,s)=>({payload:{qgId:e,questionId:t,answerId:s}})),te=m("questions/answers/setOne",(e,t,s)=>({payload:{qgId:e,qId:t,answer:s}})),se=m("questions/answers/unselectOne",(e,t)=>({payload:{qgId:e,qId:t}})),ne=m("questions/answers/unselectAll");m("questions/answers/shuffleOne",(e,t,s)=>({payload:{questionId:e,question:t,shuffle:s}}));m("questions/answers/shuffleAll",(e,t)=>({payload:{questions:e,shuffle:t}}));const Qe=(e,t)=>{if(t.type===Oe.type)return{...e,qg:[...e.qg,t.payload.question]};if(t.type===Se.type)return{...e,qg:e.qg.filter(s=>s.id!==t.payload.questionId)};if(t.type===Ne.type)return{...e,...e.qg.map(s=>s.id===t.payload.questionId?{...s,...t.payload}:s)};if(t.type===$.type){const{shuffle:s,test:n}=t.payload;return n==null?void 0:n.shuffled(s)}if(t.type===Y.type){const{shuffle:s}=t.payload;return e.shuffled(s)}return t.type===ee.type?e.selectAnswer(t.payload.qgId,t.payload.questionId,t.payload.answerId):t.type===te.type?e.setAnswer(t.payload.qgId,t.payload.qId,t.payload.answer):t.type===ne.type?e.unselectAll():t.type===se.type?e.unselectAnswer(t.payload.qgId,t.payload.qId):{...e}};let k=localStorage.getItem("settings");k=k?JSON.parse(k):null;const re=k||{subject:"",testId:"",test:void 0,unblurredQuestion:"",sidebarOn:!1,testModeOn:!1,correctAnswers:!1,shuffleQuestions:!1,shuffleAnswers:!1,blurAnswers:!1};function Me(){const[e,t]=c.useState(re);return c.useEffect(()=>{localStorage.setItem("settings",JSON.stringify(e))},[e]),[e,t]}const Pe=re;function ke(){var e,t,s;return((s=(t=(e=this.ag)==null?void 0:e.answers)==null?void 0:t.find(n=>n.selected))==null?void 0:s.id)??""}function Te(){var e,t,s;return((s=(t=(e=this.ag)==null?void 0:e.answers)==null?void 0:t.find(n=>n.correct))==null?void 0:s.id)??""}function Ee(){let e=this.correctId();return!!e&&e===this.selectedId()}function Ge(){var e,t;return!!this.questionText&&(((t=(e=this.ag)==null?void 0:e.answers)==null?void 0:t.some(s=>s.correct))??!1)}function $e(e){var t,s;return{...this,ag:{...this.ag,answers:(s=(t=this.ag)==null?void 0:t.answers)==null?void 0:s.map(n=>({...n,selected:n.id===e}))}}}function De(e){const t=s=>this.type==="MATCHING_Q"?s.answers.filter(n=>n.correct):s.answers;return{...this,ag:{...this.ag,answers:[...t(this.ag),e]}}}function _e(){var e,t;return this.type==="MATCHING_Q"?{...this,ag:{...this.ag,answers:(t=(e=this.ag)==null?void 0:e.answers)==null?void 0:t.filter(s=>s.correct)}}:this.selectAnswer("")}function Ue(){return this.questions.filter(e=>e.isCorrect()).length}function He(){return this.questions.filter(e=>e.countable()).length}function Re(e){const t={};this.questions.forEach(i=>t[i.id]=i.selectedId());const s=i=>i.selectAnswer(t[i.id]),n=()=>Math.random()-.5;let r=[...this.cache.questions].map(s);return e&&(r=r.sort(n)),{...this,shuffle:e,questions:r}}function Be(e,t){return{...this,questions:this.questions.map(s=>s.id===e?s.selectAnswer(t):s)}}function Le(e,t){return{...this,questions:this.questions.map(s=>s.id===e?s.addAnswer(t):s)}}function Fe(){return{...this,questions:this.questions.map(e=>e.unselectAnswer())}}function Ve(e){return{...this,questions:this.questions.map(t=>t.id===e?t.unselectAnswer():t)}}function We(e){var t;return((t=this.questions.find(s=>s.selectedId()===e))==null?void 0:t.id)??""}function Ke(){return this.qg.reduce((e,t)=>e+t.correctAnswersCount(),0)}function Xe(){return this.qg.reduce((e,t)=>e+t.countablesCount(),0)}function ze(e){return{...this,shuffle:e,qg:this.qg.map(t=>t.shuffled(e))}}function Ze(e,t,s){return{...this,qg:this.qg.map(n=>n.id===e?n.selectAnswer(t,s):n)}}function Je(e,t,s){return{...this,qg:this.qg.map(n=>n.id===e?n.setAnswer(t,s):n)}}function Ye(){return{...this,qg:this.qg.map(e=>e.unselectAll())}}function et(e,t){return{...this,qg:this.qg.map(s=>s.id===e?s.unselectAnswer(t):s)}}function y({id:e,value:t="",correct:s,selected:n,image:r,imageAlt:i}){return{id:e||p(),value:t,correct:s,selected:n,image:r,imageAlt:i}}function x({id:e,answers:t=[]}){return{id:e||p(),answers:t}}const E={countable:Ge,isCorrect:Ee,selectedId:ke,correctId:Te,selectAnswer:$e,unselectAnswer:_e,addAnswer:De},G={countablesCount:He,correctAnswersCount:Ue,shuffled:Re,selectAnswer:Be,setAnswer:Le,unselectAll:Fe,unselectAnswer:Ve,selectingId:We};function F({id:e,questionText:t,ag:s,image:n,imageAlt:r}){return{id:e||p(),questionText:t,ag:s||x({}),type:"MULTICHOICE_Q",image:n,imageAlt:r,...E}}function tt({id:e,questions:t,image:s,imageAlt:n}){return{id:e||p(),type:"MULTICHOICE_QG",image:s,imageAlt:n,questions:t,cache:{questions:t},...G}}function V({id:e,questionText:t,answerValue:s=!0,image:n,imageAlt:r}){return{id:e||p(),questionText:t,ag:x({answers:[y({value:s,correct:!0})]}),type:"TRUEORFALSE_Q",image:n,imageAlt:r,...E}}function st({id:e,questions:t,image:s,imageAlt:n}){return{id:e||p(),image:s,imageAlt:n,type:"TRUEORFALSE_QG",questions:t,cache:{questions:t},...G}}function W({id:e,questionText:t,answerValue:s=0,image:n,imageAlt:r}){return{id:e||p(),questionText:t,ag:x({answers:[y({value:s,correct:!0})]}),type:"VALUE_Q",image:n,imageAlt:r,...E}}function nt({id:e,questions:t,image:s,imageAlt:n}){return{id:e||p(),image:s,imageAlt:n,type:"VALUE_QG",questions:t,cache:{questions:t},...G}}function K({id:e=p(),questionText:t,ag:s=x({}),image:n,imageAlt:r}){return{id:e,questionText:t,ag:s,image:n,imageAlt:r,type:"MATCHING_Q",...E}}function rt({id:e,questions:t,image:s,imageAlt:n}){return{id:e||p(),image:s,imageAlt:n,type:"MATCHING_QG",questions:t,cache:{questions:t},...G}}function j(e){let t=/!\[(.*)\]\((.*)\)/,s=e.replace(t,""),[,n,r]=t.exec(e)||[];return[!!r,n,r,s]}function ot(e){if(e=e.trim(),!e.length)return F({});const[t,s,n,r]=j(e),[i,a,...q]=r.split(`
`).filter(l=>l.trim().length);return F({questionText:i,image:n,imageAlt:s,ag:x({answers:q.map((l,u)=>y({id:p(),value:l,correct:u+1===Number(a)}))})})}function it(e){const t=e.split("#q#").map(s=>s.trim()).filter(s=>s.length).map(ot);return tt({id:p(),questions:t})}function ct(e){if(e=e.trim(),!e.length)return K({});const[t,s,n,r]=j(e),[i,a]=r.split(`
`);return K({questionText:i,image:s,imageAlt:n,ag:x({answers:[y({id:p(),value:a,correct:!0})]})})}function qt(e){const[t,s,n,r]=j(e),i=r.split("#q#").map(ct);return rt({id:p(),questions:i,image:s,imageAlt:n})}function at(e){if(e=e.trim(),!e.length)return V({});const[t,s,n,r]=j(e),[i,a]=r.split(`
`).map(q=>q.trim());return V({questionText:i,image:s,imageAlt:n,ag:x({answers:[y({id:p(),value:"True",correct:a==="1"}),y({id:p(),value:"False",correct:a==="0"})]})})}function lt(e){const[t,s,n,r]=j(e),i=r.split("#q#").map(at);return st({id:p(),questions:i,image:s,imageAlt:n})}function ut(e){if(e=e.trim(),!e.length)return W({});const[t,s,n,r]=j(e),[i,a]=r.split(`
`);return W({questionText:i,image:s,imageAlt:n,ag:x({answers:[y({id:p(),value:a})]})})}function dt(e){const[t,s,n,r]=j(e),i=r.split("#q#").map(ut);return nt({id:p(),questions:i,image:s,imageAlt:n})}function w(e,t){const s=[];return t.split("#qg#").forEach(r=>{const[i,a]=r.split("#qt#").map(q=>q.trim());switch(i){case"#multichoice#":s.push(it(a));break;case"#matching#":s.push(qt(a));break;case"#trueorfalse#":s.push(lt(a));break;case"#value#":s.push(dt(a));break}}),{id:p(),title:e,qg:s,correctAnswersCount:Ke,countables:Xe,shuffled:ze,selectAnswer:Ze,setAnswer:Je,unselectAll:Ye,unselectAnswer:et,cache:{qg:s}}}const ft=`
...
`,Qt=w("إدارة جودة — 2",Nt),T=[pt,St,Qt,xt,bt,mt,wt,yt,It],Mt=()=>{},D=c.createContext(T),_=c.createContext(T[0]),S=c.createContext(()=>{}),C=c.createContext(Pe),N=c.createContext(Mt),Pt=({children:e})=>{const[t,s]=Me(),[n,r]=c.useReducer(Qe,T[0]);return o.jsx(N.Provider,{value:s,children:o.jsx(S.Provider,{value:r,children:o.jsx(D.Provider,{value:T,children:o.jsx(C.Provider,{value:t,children:o.jsx(_.Provider,{value:n,children:e})})})})})};function kt(){const e=c.useContext(C),t=c.useContext(_),s=c.useContext(S),n=e.testModeOn&&e.correctAnswers,r=c.useMemo(()=>e.testModeOn?t.correctAnswersCount():0,[t]);return o.jsxs("div",{className:`bottombar ${n?"":"none"}`,children:[o.jsxs("div",{className:"score",children:[o.jsx("span",{className:"score__label",children:"Score: "}),o.jsxs("span",{className:"score__value",children:[r,"/",t.countables()]})]}),o.jsx("div",{className:"actions",children:o.jsx("button",{className:"",onClick:()=>s(ne()),children:"مسح الإجابات"})})]})}const Tt=""+new URL("burger.svg",import.meta.url).href;function Et(){var n;const e=c.useContext(C),t=c.useContext(N);function s(){t(r=>({...r,sidebarOn:!0}))}return c.useEffect(()=>{console.log("installed kepress listener @Header"),document.addEventListener("keypress",r=>{r.key==="a"?t(i=>({...i,sidebarOn:!i.sidebarOn})):r.key==="s"?t(i=>({...i,shuffleQuestions:!i.shuffleQuestions})):r.key==="c"?t(i=>({...i,blurAnswers:!i.blurAnswers})):r.key==="q"?t(i=>({...i,testModeOn:!i.testModeOn})):r.key==="w"?t(i=>({...i,correctAnswers:!i.correctAnswers})):r.code==="Space"&&(t(i=>({...i,shuffleAnswers:!1,testModeOn:!1,correctAnswers:!1,blurAnswers:!1,sidebarOn:!1})),r.preventDefault())})},[]),o.jsxs("div",{className:"burger-btn sticky top-0 min-h-[50px] px-4 flex items-center justify-between bg-green-700 ",children:[o.jsx("div",{children:o.jsx("img",{className:"cursor-pointer",onClick:s,src:Tt,alt:"Menu"})}),o.jsx("div",{onClick:()=>{},className:"text-slate-200 border-double border-b-4 text-xl cursor-pointer",children:(n=e.test)==null?void 0:n.title}),o.jsx("div",{})]})}function Gt({questPanel:e}){const t=c.useContext(C),s=t.testModeOn&&t.correctAnswers?"raise":"",n=t.sidebarOn?"none":"",[r,i]=c.useState("");return o.jsx("div",{className:`scroll-top ${s} ${n} ${r}`,onClick:()=>{var a;return(a=e.current)==null?void 0:a.scrollTo({top:0,behavior:"smooth"})},onPointerMoveCapture:()=>i("hover"),onPointerDownCapture:()=>i("hover"),onPointerOutCapture:()=>i(""),onPointerUp:()=>i("")})}function $t({defaultValue:e=!1,enabled:t=!0,onChange:s,setToggle:n,...r}){const i=c.useId(),a=c.useRef(null),q=u=>{var h;return s?s(((h=u.target)==null?void 0:h.checked)||!1):null};return n&&n(()=>{var u;return(u=a.current)==null?void 0:u.click()}),o.jsxs("label",{style:{},htmlFor:i,className:`toggle-switch ${t?"":"disabled"}`,children:[o.jsx("input",{id:i,ref:a,type:"checkbox",onChange:q,disabled:!t,onClick:u=>u.stopPropagation(),defaultChecked:e,...r}),o.jsx("span",{className:"slider"})]})}function Dt({questPanel:e}){const t=c.useContext(C),s=c.useContext(N),n=c.useContext(D),r=c.useContext(S),{sidebarOn:i}=t,a=(q,l)=>{var u;switch(q){case"selectedSubject":const h=n.find(A=>A.id===l);return(u=e.current)==null||u.scrollTo({top:0,behavior:"smooth"}),s({...t,sidebarOn:!1,test:h}),r($(h,t.shuffleQuestions));case"testModeOn":return s({...t,testModeOn:l});case"correctAnswers":return s({...t,correctAnswers:l});case"blurAnswers":return s({...t,blurAnswers:l});case"shuffleQuestions":return s({...t,shuffleQuestions:l}),r(Y(l));case"shuffleAnswers":return s({...t,shuffleAnswers:l});default:return}};return o.jsxs("div",{className:"absolutez",children:[o.jsxs("nav",{onClick:q=>q.stopPropagation(),className:`${i?"":"off"} sidebar`,children:[o.jsx("h2",{className:"title",children:"البنك"}),o.jsxs("div",{className:"subjects",children:[o.jsx("div",{className:"sep"}),n.map(q=>{var l;return o.jsx("div",{className:`item ${((l=t.test)==null?void 0:l.id)===q.id?"active":""}`,onClick:()=>a("selectedSubject",q.id),children:q.title},q.id)})]}),o.jsxs("div",{className:"settings",children:[o.jsx("div",{className:"sep"}),o.jsx("div",{className:"title",children:"الاعدادات"}),o.jsx("div",{className:"sep"}),o.jsx(P,{title:"وضع الإختبار",defaultValue:t.testModeOn,action:q=>a("testModeOn",q)}),o.jsx(P,{title:"تصحيح الإجابات",enabled:t.testModeOn,defaultValue:t.correctAnswers,action:q=>a("correctAnswers",q)}),o.jsx("p",{}),o.jsx(P,{title:"تغشية الإجابات",enabled:!t.testModeOn,defaultValue:t.blurAnswers,action:q=>a("blurAnswers",q)}),o.jsx(P,{title:"مزج الأسئلة",defaultValue:t.shuffleQuestions,action:q=>a("shuffleQuestions",q)})]}),o.jsxs("div",{className:"credits",children:[o.jsx("div",{className:"sep"}),o.jsx("div",{className:"title",children:"الحقوق"}),o.jsx("div",{className:"sep"}),o.jsx("div",{className:"item",children:"motifyee@gmail.com"}),o.jsx("div",{className:"item",children:"م/ مليك روماني"})]})]}),o.jsx("div",{onPointerMove:q=>q.stopPropagation(),onPointerDownCapture:q=>q.stopPropagation(),onPointerDown:q=>q.stopPropagation(),onClick:()=>s({...t,sidebarOn:!1}),className:`${i?"":"off"} sidebar-overlay`})]})}function P({title:e,defaultValue:t,action:s,enabled:n=!0}){let r=()=>{};const i=a=>r=a;return o.jsxs("div",{onClick:a=>{a.preventDefault(),r()},className:"flex justify-between items-center item",children:[o.jsx("div",{className:`${n?"":"text-gray-500 xline-through"}`,children:e}),o.jsx($t,{defaultValue:t,enabled:n,onChange:s,setToggle:i})]})}const v={};function _t(e,t,s=!0,n=100){c.useDebugValue(v);const[r,i]=c.useState(!1),a=l=>{var u;return(v[e]={...v[e],captured:l??((u=v[e])==null?void 0:u.captured)??!1}).captured};return r||a()||(t&&!s&&t(),!v[e].skip&&(t&&s&&t(),i(()=>a(!0)),setTimeout(()=>i(!1),n))),!r&&a()&&a(!1),[r,()=>e in v?v[e].skip=!0:!1]}const X=(e=35)=>("vibrate"in navigator&&navigator.vibrate(e),!0);function Ut({question:e,qgId:t,settings:s}){var A;const n=c.useContext(S),r=f=>{if(!s.testModeOn)return console.log("testMode is off");if(s.correctAnswers&&e.selectedId())return X(60)&&console.log("already selected");n(ee(t,e.id,f)),X()},i="bg-amber-700",a="bg-green-700",q="bg-red-700",l="bg-slate-800";function u(f){return s.testModeOn?s.correctAnswers?e.selectedId()?f.selected?e.isCorrect()&&e.type==="MATCHING_Q"||f.correct?a:q:f.correct?a:l:l:f.selected?i:l:f.correct?a:l}function h(f){return e.type==="MATCHING_Q"?s.testModeOn&&f.selected?!0:!!(!s.testModeOn&&f.correct):!!f.id}return o.jsx(o.Fragment,{children:(A=e.ag)==null?void 0:A.answers.map((f,b)=>h(f)?o.jsxs("div",{className:`quest-answer ${u(f)}`,children:[o.jsx("input",{type:"radio",onClick:U=>r(f.id),name:"answer",id:`answer-${e.id}${b}`,className:"hidden"}),o.jsx("label",{htmlFor:`answer-${e.id}${b}`,className:"quest-answerlable p-2",children:f.value})]},f.id):null)})}function Ht({qgId:e,index:t,question:s,blurred:n,unblur:r,settings:i,selected:a,onClick:q,setRef:l}){const[u]=_t(s.id,()=>"",!0,300),h=c.useRef(null);c.useEffect(()=>{l&&l(h,s)},[h]);const A=!!s.selectedId(),f=s.isCorrect(),b=A&&i.correctAnswers?f?"correct":"incorrect":"";return o.jsxs("div",{ref:h,className:`quest-container ${a?"selected":""}`,onClick:()=>q?q(s):null,children:[o.jsxs("h2",{className:`quest-text ${u&&(s.type==="MATCHING_Q"?"bg-slate-800":"bg-slate-600")||""}`,children:[o.jsx("span",{className:`quest-span ${b}`,children:t}),o.jsx("span",{children:s.questionText}),s.image&&o.jsx("img",{src:"./assets/"+s.image,alt:s.imageAlt,className:"quest-image w-full h-auto my-2 "})]}),o.jsxs("div",{className:"quest-answers",children:[n&&o.jsx("div",{className:"blur",onDoubleClick:()=>r(s.id)}),o.jsx(Ut,{settings:i,question:s,qgId:e})]})]})}const oe=c.memo(Ht);function Rt({qg:e,index:t}){const s=c.useContext(C),n=c.useContext(N),r=l=>s.unblurredQuestion!==l&&s.blurAnswers&&!s.testModeOn,i=c.useCallback(l=>n(u=>({...u,unblurredQuestion:l})),[]),a=c.useMemo(()=>({testModeOn:s.testModeOn,correctAnswers:s.correctAnswers}),[s.testModeOn,s.correctAnswers]),{questions:q}=e;return o.jsxs("div",{className:"qg question-group",children:[o.jsx("div",{className:"qg-title",children:"اختيار من متعدد"}),o.jsx("div",{className:"questions",children:q.map((l,u)=>o.jsx("div",{children:o.jsx(oe,{qgId:e.id,question:l,index:t+u+1,blurred:r(l.id),unblur:i,settings:a})},l.id))})]})}const M=(e=35)=>("vibrate"in navigator&&navigator.vibrate(e),!0);function Bt({qg:e,index:t}){const s=c.useContext(C),n=c.useContext(N),r=d=>s.unblurredQuestion!==d&&s.blurAnswers&&!s.testModeOn,i=c.useCallback(d=>n(g=>({...g,unblurredQuestion:d})),[]),a=c.useMemo(()=>({testModeOn:s.testModeOn,correctAnswers:s.correctAnswers}),[s.testModeOn,s.correctAnswers]),[q,l]=c.useState({}),[u,h]=c.useState(""),[A,f]=c.useState({});c.useEffect(()=>{let d={};const g=()=>Math.random()-.5;[...e.questions].sort(g).forEach(I=>{var O;(O=I.ag)==null||O.answers.forEach(Q=>{d[Q.id]=Q})}),f(d)},[]),c.useEffect(()=>{h("")},[s.testModeOn,s.correctAnswers]);const b=c.useContext(S),U=c.useCallback(d=>{if(s.testModeOn){if(d.selectedId()&&s.correctAnswers)return M(60);h(d.id),M()}},[s.testModeOn,s.correctAnswers]),ie=d=>e.selectingId(d)?"selected":"",ce=c.useCallback((d,g)=>l(I=>({...I,[g.id]:d})),[]),qe=c.useCallback((d,g,I)=>{var Q,H;let O=d.selectingId(I.id);if(!g)return((H=(Q=q[O])==null?void 0:Q.current)==null?void 0:H.scrollIntoView({behavior:"smooth",block:"center"}))&&M();if(O&&s.testModeOn&&s.correctAnswers)return M(60);b(se(d.id,O)),b(te(d.id,g,{...I,selected:!0,correct:!1})),h(""),M()},[u,s.testModeOn,s.correctAnswers]);return o.jsxs("div",{className:"qg",children:[o.jsx("div",{className:"qg-title",children:"صل الإجابة الصحيحة"}),o.jsx("div",{className:"questions",children:e.questions.map((d,g)=>o.jsx("div",{children:o.jsx(oe,{qgId:e.id,question:d,index:t+g+1,blurred:r(d.id),unblur:i,settings:a,onClick:U,selected:u===d.id,setRef:ce})},d.id))}),s.testModeOn&&o.jsxs("div",{className:"quest-container matching-answers-container relative ",children:[o.jsx("div",{className:"matching-answers-title",children:"اختر الإجابة"}),o.jsx("div",{className:"quest-answers matching-answers",children:Object.values(A).map(d=>o.jsx("div",{onClick:()=>qe(e,u,d),className:`matching-answer ${ie(d.id)}`,children:o.jsx("div",{children:d.value})},d.id))})]})]})}function Lt({questPanel:e}){const t=c.useContext(_),s=c.useContext(C),n=c.useContext(N),r=c.useContext(D),i=c.useContext(S);c.useEffect(()=>{let q=r.find(l=>{var u;return l.title===((u=s.test)==null?void 0:u.title)});q||(console.log("init",q,s),n({...s,test:r[0]}),q=r[0]),i($(q,s.shuffleQuestions))},[]);function a(q,l){switch(q.type){case"MULTICHOICE_QG":return o.jsx(Rt,{qg:q,index:l+1});case"MATCHING_QG":return o.jsx(Bt,{qg:q,index:l+1});default:return null}}return o.jsx("div",{ref:e,className:"questions  overflow-y-auto",children:t==null?void 0:t.qg.map((q,l)=>o.jsxs("div",{children:[a(q,l),o.jsx("br",{})]},q.id))})}const Ft=()=>{const e=c.useRef(null);return o.jsxs(Pt,{children:[o.jsx(Et,{}),o.jsx(Dt,{questPanel:e}),o.jsx(Lt,{questPanel:e}),o.jsx(Gt,{questPanel:e}),o.jsx(kt,{})]})},Vt=()=>o.jsx(o.Fragment,{children:"loaderio-2234f8976d3152a88c2083c9e1047a5c"}),Wt=document.getElementById("root");function Kt(){return c.useEffect(()=>{window.location.href.includes("http://localhost")||ye()},[]),o.jsx(he,{children:o.jsxs(me,{children:[o.jsx(R,{path:"/",element:o.jsx(Ft,{})}),o.jsx(R,{path:"/loader.io",element:o.jsx(Vt,{})})]})})}ae.createRoot(Wt).render(o.jsx(Kt,{}));
